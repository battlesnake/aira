...
func TestConfineOOMAttributionAdvisoryIsNeverSilent(t *testing.T) {
	...
	if advisory := formatConfineReserveAdvisory(32<<20, nil, confineOwnCapAdviceWarranted(usage), ConfineCapSourceMemoryMax, 64<<30); strings.Contains(advisory, "OOM-killed at its memory cap") {
