...
`), &out, &bytes.Buffer{}); err != nil {
	...
	want := []string{"aira_check", "aira_claim", "aira_commands", "aira_confine_budget", "aira_confine_input", "aira_confine_kill", "aira_confine_list", "aira_confine_log", "aira_count", "aira_create", "aira_eject", "aira_finding", "aira_gate", "aira_get", "aira_git", "aira_grep", "aira_heartbeat", "aira_id", "aira_import", "aira_init", "aira_insights", "aira_intent_retire", "aira_lease", "aira_link", "aira_list", "aira_quota", "aira_rant", "aira_ready", "aira_reconcile", "aira_release", "aira_requirement", "aira_review", "aira_run", "aira_run_input", "aira_run_kill", "aira_run_output", "aira_spend", "aira_test_report", "aira_time", "aira_touch", "aira_transition", "aira_worktree_audit", "aira_worktree_register"}
