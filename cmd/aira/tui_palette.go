...
// AIRA-135's used/idle split is drawn in ONE slot colour by block character
// (a solid █ for the used part, a shaded ▒ for the idle remainder), so there is
// no second, darkened shade of a slot colour to compute here. The glyphs live
// in tui.go's topBarGlyph.
