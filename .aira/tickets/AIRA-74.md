---
{"schema":1,"id":"AIRA-74","project":"aira","title":"aira grep rebuilds the whole FTS index on every query, under a machine-wide lock","status":"done","kind":"bug","severity":"P1","assignee":null,"milestone":null,"labels":["dogfood","performance","query","store"],"hold":false,"relations":[]}
---
