---
{"schema":1,"id":"AIRA-102","project":"aira","title":"Docker containers structurally escape aira.slice — no admission accounting, no aggregate memory cap","status":"done","kind":"bug","severity":"P1","assignee":null,"milestone":null,"labels":["confine","docker","dogfood","memory-safety"],"hold":false,"relations":[{"kind":"relates","from":"AIRA-197","to":"AIRA-102"}]}
---
