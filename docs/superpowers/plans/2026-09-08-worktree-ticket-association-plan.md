...
Status: **plan — not yet gated, not yet built.** This document proposes a
design; it is deliberately not a committed implementation spec the way
tonight's AIRA-149/151/153 plans were, because the owner asked for a plan
first, not a build.
