...
> **HISTORIC — not current.** Landed 2026-09-08, ~475 commits after this
> review's base commit (`994abee`, 2026-09-03). It was never merged at the
> time and the subsystem it reviews has changed substantially since
> (AIRA-101, 106, 114, 149, 151, 153, 160, 172, 177, 178, 181, 185, 186, 187
> among many others touching confine/admission directly). Most of its
> concrete findings were independently extracted into tickets and built —
> AIRA-71/72/73/74/75/76/77/89 all address items raised here and are
> `done`. Kept as a record of the original analysis and any proposals that
> were *not* separately actioned, not as a current assessment of the
> subsystem. Do not use this document's specifics (line numbers, "still
> present" claims, or anything not confirmed against a since-`done` ticket)
> as evidence about the present state of the code — re-verify against
