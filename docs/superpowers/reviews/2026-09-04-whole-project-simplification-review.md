...
> **HISTORIC — not current.** Landed 2026-09-08, ~470 commits after this
> review's base commit (`9a65d47`, 2026-09-04). It was never merged at the
> time and the codebase has moved substantially since: most of its concrete
> findings were independently extracted into tickets and built —
...
> codebase. Do not use this document's specifics (line numbers, "still
